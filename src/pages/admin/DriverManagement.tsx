import DriverManagementTable from "@/components/modules/admin/DriverManagementTable";
import { useManageDriversQuery } from "@/redux/features/admin/admin.api";
...
const DriverManagement = () => {
  ...
  const { data, isLoading } = useManageDriversQuery({
    page,
    limit,
