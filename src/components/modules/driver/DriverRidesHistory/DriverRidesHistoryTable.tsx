...
// Interfaces for IDriverRidesHistory, Meta & IProps
interface IDriverRidesHistory {
  _id: string;
  userId: {
    _id: string;
    name: string;
...
// DriverRidesHistoryTable Component
const DriverRidesHistoryTable = ({
  data,
  onPageChange,
  currentPage,
  onStatusChange,
    ...
    <>
      ...
      <div className="border max-w-7xl mx-auto p-4 rounded-2xl">
        <Table>
          ...
          {/* table body */}
          <TableBody>
            {historyData?.map((history: IDriverRidesHistory, index: number) => (
              <TableRow
                key={history?._id}
...
export default DriverRidesHistoryTable;
